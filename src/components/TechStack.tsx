...
const techStack = [
  ...
  },
  {
    name: "Next.js",
    category: "Frontend",
    icon: "/src/assets/icons/nextdotjs.png",
    color: "#000000",
  },
  {
    name: "Redux",
  ...
  },
  {
    name: "Tailwind CSS",
    category: "Frontend",
    icon: "/src/assets/icons/tailwindcss.png",
    color: "#06B6D4",
  },
  ...
  },
  {
    name: "Node.js",
    category: "Backend",
    icon: "/src/assets/icons/nodedotjs.png",
    color: "#339933",
  },
  {
    name: "Express.js",
...
const TechCard = ({
  ...
  return (
    ...
    >
      ...
      >
        {/* Tech Icon */}
        <div className="relative mb-4 mx-auto w-20 h-20 flex items-center justify-center rounded-full bg-white p-4 shadow-md">
          <img
            src={tech.icon}
            alt={tech.name}
...
const TechStack = () => {
  ...
  const categories = [
    {
      name: "Frontend",
      techs: techStack.filter((t) => t.category === "Frontend"),
    },
    {
      name: "Backend",
      techs: techStack.filter((t) => t.category === "Backend"),
    },
    {
      name: "Database",
      techs: techStack.filter((t) => t.category === "Database"),
    },
